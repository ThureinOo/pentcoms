---
description: |
  Nmap is the go-to network scanner for host discovery, port scanning, service/version detection, and vulnerability checks. Supports TCP, UDP, scripting engine (NSE), and multiple output formats.
command: |
  nmap
items:
  - No_Creds
...
Ping sweep a subnet, skip port scan:
```
nmap -sn 10.10.10.27/24
```
...
nmap -sCV -p <open_ports_from_above> 10.10.10.27
```
